...
def save_model(model, accuracy, best_accuracy, save_path):
    ...
    model_name = f"Text_recognition_model_{today_date}.pth"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train a CRNN model for Rendered Hindi Text Recognition.')
    parser.add_argument('--epochs', type=int, default=25, help='Number of epochs to train the model (default: 25)')
